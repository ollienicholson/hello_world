...
export const past_5 = (h: number, m: number, s: number): number => (h * 3600 + m * 60 + s) * 1000;
...
export const setAlarm3 = (employed: boolean, vacation: boolean) => employed && !vacation;
...
export const feast_3 = (beast:string, dish:string) => first(beast) === first(dish) && last(beast) === last(dish)
